...
namespace Infrastucture.Database.Migrations
{
    ...
    [Migration("20260521091145_AddUserRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "outbox_message_status", new[] { "pending", "processing", "processed", "failed" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "outbox_message_type", new[] { "email_job" });
            ...
            modelBuilder.Entity("Domain.Features.Auth.Entities.UserIdentity", b =>
                {
                    ...
                    b.Property<IdentityProvider>("Provider")
            ...
            modelBuilder.Entity("Domain.Features.Auth.Entities.UserRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Features.Outbox.Entities.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<OutboxMessageStatus>("Status")
                        .HasColumnType("outbox_message_status")
                        .HasColumnName("status");

                    b.Property<OutboxMessageType>("Type")
                    ...
                    b.ToTable("outbox_messages", null, t =>
                        {
                            t.HasCheckConstraint("ck_outbox_messages_retry_count_range", "retry_count >= 0 AND retry_count <= 10");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Features.Auth.Entities.UserRefreshToken", b =>
                {
                    b.HasOne("Domain.Features.Auth.Entities.UserRefreshToken", null)
                        .WithMany()
